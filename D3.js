...
console.log("esercizio2... ", charactersNames);
...
console.log("esercizio3... ", femaleCharacters);
...
console.log("esercizio5... ", eyeColor);
...
console.log("esercizio6... ", crewMass);

let crewMass2 = 0;

for (let i = 0; i < starWarsCharacters.length; i++) {
  crewMass2 += starWarsCharacters[i].mass;
}
console.log("esercizio6... con for.... ", crewMass2);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a") {
    ...
    console.log("esercizio 8... ", starWarsCharacters[i]);
  }
}
